...
public class PredicateExample {
    ...
    public static void predicateOr(){
        ...
        System.out.println("Predicate And result is :" + p1.or(p2).test(8)); // predicate chaining
    }

    public static void predicateNegate(){
        System.out.println("Predicate And result is :" + p1.or(p2).negate().test(8)); // predicate chaining
    }
